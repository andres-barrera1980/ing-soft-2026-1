...
| **¿Por qué elegiste este LLM?** | [No use ia para resolver el parcial, porque queria retarme a usar unicmanete mis conocimientos adquiridos en clase y el dominio de los temas para resolver el parcial] |
